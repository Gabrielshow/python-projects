...
# I need to create an excel sheet of birthdays in order for this to work
...
def send_email(recipient, subject, msg):
   GMAIL_ID = 'adefelashogbanmu@gmail.com'
   GMAIL_PWD = 'your_password_here' #to get this from the site
